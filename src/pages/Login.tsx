  ...
  return (
    <div className="min-h-screen bg-[#06060b] flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] bg-indigo-600/[0.03] rounded-full blur-[100px]" />
      </div>
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-600 text-xs mt-1">Sign in to your monitoring dashboard</p>
        </div>
